...
final_metrics <- data.frame(
  Model = c("Ridge (Both)", "Ridge (Image)", "Lasso (Both)", "Lasso (Image)", 
...
library(knitr)
kable(final_metrics, caption = "Model Evaluation Metrics (MSE and RMSE)", digits = 4)
```
...
kable(auc_results, caption = "Table 4: Model Comparison: AUC and ROC", digits = 4)
...
kable(auc_results, caption = "Table 5: Model Comparison: AUC, Accuracy, and F1-Score", digits = 4)
...
kable(auc_table, 
      caption = "Table 6: Comparison of AUC Values for All Models (Testing)", 
