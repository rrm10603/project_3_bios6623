...
kable(auc_roc__results, caption = "Model Comparison: AUC and ROC", digits = 4)
...
auc_table <- data.frame(
  Model = c("Logistic (tkvht_base)", 
            "Logistic (Imaging)", 
            "Logistic (tkvht_base - Logit)", 
...
# Round AUC values to two decimal places
auc_table$AUC <- round(auc_table$AUC, 2)

# Create a clean table with kable
kable(auc_table, 
      caption = "Comparison of AUC Values for Different Models", 
